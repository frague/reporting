...
SaveWikiPage(wikiServer, wikiToken, config["personal_space"], "ActiveMQ queues utilization (autogenerated)", FillTemplate(page, {"##CONSUMERS##": subscribers, "##QUEUES##": "".join(result), "##UPDATED##": datetime.datetime.today().strftime("%b %d, %Y (%H:%M)")}))
